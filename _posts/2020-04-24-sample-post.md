---
title: Sample Belform
layout: post
post-image: "https://raw.githubusercontent.com/belform/WhatATheme/master/assets/images/SamplePost.png?token=AHMQUEPC4IFADOF5VG4QVN26Z64GG"
...
This post will show you how the content will look like in the post pages and how the headlines, quotes and quotes will be represented. Belform is mainly used to write simple markdown and after that it renders out a static pages, so you need to know the basics of writing markdown for that.
